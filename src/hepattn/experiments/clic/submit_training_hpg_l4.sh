...
#   sbatch submit_training_hpg_l4.sh configs/clic_v7.yaml
CONFIG_PATH="${1:?Usage: sbatch submit_training_hpg_l4.sh <config.yaml>}"
...
PYTORCH_CMD="python main.py fit --config $CONFIG_PATH --trainer.devices=3"
